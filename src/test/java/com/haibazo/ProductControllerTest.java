...
//                new Product(1, "Product 1", 100.0, 90.0, Color.GREEN, Size.M, "Description 1", "imageUrl1", new Style(), new Category(), null),
//                new Product(2, "Product 2", 150.0, 120.0, Color.RED, Size.L, "Description 2", "imageUrl2", new Style(), new Category(), null)
//        );
...
//        // Arrange
//        Product mockProduct = new Product(1, "Product 1", 100.0, 90.0, Color.GREEN, Size.M, "Description 1", "imageUrl1", new Style(), new Category(), null);
//        when(productService.getProductById(1)).thenReturn(mockProduct);
//
//        // Act
//        ApiResponse<Product> response = productController.getProductById(1);
//
//        // Assert
...
//        // Arrange
//        Product mockProduct = new Product(1, "Product 1", 100.0, 90.0, Color.GREEN, Size.M, "Description 1", "imageUrl1", new Style(), new Category(), null);
//        when(productService.saveProduct(any( class))).thenReturn(mockProduct);
//
//        // Act
...
//        // Arrange
//        Product mockProduct = new Product(1, "Updated Product", 120.0, 100.0, Color.RED, Size.L, "Updated Description", "imageUrl2", new Style(), new Category(), null);
...
//        verify(productService, times(1)).getProductById(1);
////        verify(productService, never()).saveProduct(any(class));
//    }
//
